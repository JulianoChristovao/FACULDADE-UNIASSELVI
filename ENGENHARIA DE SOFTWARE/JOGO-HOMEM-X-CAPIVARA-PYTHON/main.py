...
capivara1 = ('capivara_nivel_1.txt')
capivara2 = ('capivara_nivel_2.txt')
guerreiro1 = ('guerreiro_nivel_1.txt')
guerreiro2 = ('guerreiro_nivel_2.txt')
...
exibir_imagem(capivara1)

'''capivara_nivel_1.txt
...
'''
# imprime texto com o nome do jogo
art=text2art(
    "                               Game\n"
    "HOMEM    X    CAPIVARA\n")
print(art)
